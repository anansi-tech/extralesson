...
export const ModelQuestionClassificationZ = z.object({
  ...
  visual_types: z.array(VisualArchetypeZ).max(4),
...
export function buildCorpusClassificationPrompt(args: {
  ...
  return `Classify one CSEC Mathematics Paper ${args.paper} from ${args.session} ${args.year} for private curriculum research.
