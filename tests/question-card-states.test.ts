...
describe('the question card, four states', () => {
  ...
  it('3 · read, boxes filled', () => {
    expect(text.read).toBe(
      STEM +
        ...
        'We filled answer boxes. Check each entry. ' +
  ...
  it('a reasoning part with no read says what marks it, before and after hand-in', () => {
    ...
    // Handed in with nothing photographed, the marks are still earnable, so the
    // part says what marks them rather than falling silent.
