...
export default async function LandingPage() {
  ...
  return (
    <div className="landing">
      {/* GOAL. One telling of each idea, one action in the hero. */}
      ...
      {/* MECHANISM. The phone, then the three steps. */}
      <section>
        <div className="wrap">
          <div className="phone">
            <div className="page">
          ...
          <div className="wrap">
            <div className="offer">
              ...
              <p>
                ...
                Email us within {REFUND_DAYS} days of paying and we will refund you. We do not send
